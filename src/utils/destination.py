...
def places_to_pop_hexgrids(place: gpd.GeoDataFrame, pop_data: str) -> tuple[gpd.GeoDataFrame, gpd.GeoDataFrame]:
    ...
    hexgrid_no_pop = hexgrid[hexgrid.pop_density != 0]
    return hexgrid, hexgrid_no_pop
